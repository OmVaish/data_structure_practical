...
template <class T> class DoublyLinkedList{
    public:
        ...
        void concat2Lists(DoublyLinkedList<T> *list1, DoublyLinkedList<T> *list2);
        int countNode();
        void display();
        void reverse();
};
...
template <class T> void DoublyLinkedList<T>::removeAt(int index) {
    Node<T> *temp = head;
    if (index == 0) {
        head = head->next;
        if(head!=NULL)
...
template <class T> void DoublyLinkedList<T>::concat2Lists(DoublyLinkedList<T> *list1, DoublyLinkedList<T> *list2) {
...
template <class T> void DoublyLinkedList<T>::addHead(T data) {
...
template <class T> void DoublyLinkedList<T>::count() {
    Node<T> *temp = head;
    int count = 0;
    while (temp != NULL) {
        count++;
...
template <class T> void DoublyLinkedList<T>::insertAt(T data, int index) {
    if (index == 0) {
        addHead(data);
    } else {
        Node<T> *newNode = new Node<T>(data);
...
template <class T> void DoublyLinkedList<T>::addTail(T data) {
    Node<T> *newNode = new Node<T>(data);
    if (isEmpty()) {
        head = newNode;
        tail = newNode;
...
template <class T> T DoublyLinkedList<T>::deleteHead() {
    if (isEmpty()) {
        throw "List is empty";
    }else if(head==tail)
    {
...
template <class T> void DoublyLinkedList<T>::deleteNode(T data) {
    if (isEmpty()) {
        cout<< "List is empty"<<endl;
        return;
    } 
...
template <class T>  Node<T>* DoublyLinkedList<T>::search(T data) {
    if (isEmpty()) {
        return NULL;
    } else {
        Node<T> *temp = head;
...
template <class T> int DoublyLinkedList<T>::countNode() {
    if (isEmpty()) {
        cout<< "List is empty"<<endl;
        return -1;
    } 
